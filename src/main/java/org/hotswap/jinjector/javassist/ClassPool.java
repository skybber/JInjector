...
import org.hotswap.jinjector.javassist.util.proxy.DefinePackageHelper;
...
public class ClassPool {
    ...
    {
        try {
            return org.hotswap.jinjector.javassist.util.proxy.DefineClassHelper.toClass(neighbor,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
    ...
    {
        try {
            return org.hotswap.jinjector.javassist.util.proxy.DefineClassHelper.toClass(lookup,
                                                            ct.toBytecode());
        }
        catch (IOException e) {
            throw new CannotCompileException(e);
    ...
    {
        try {
            return org.hotswap.jinjector.javassist.util.proxy.DefineClassHelper.toClass(ct.getName(),
