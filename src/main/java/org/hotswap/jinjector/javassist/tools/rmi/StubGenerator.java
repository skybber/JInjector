...
package org.hotswap.jinjector.javassist.tools.rmi;
...
import org.hotswap.jinjector.javassist.CtNewConstructor;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "org.hotswap.jinjector.javassist.tools.rmi.Sample";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "org.hotswap.jinjector.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "org.hotswap.jinjector.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("org.hotswap.jinjector.javassist.tools.rmi.RemoteException") };
    }
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("org.hotswap.jinjector.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
