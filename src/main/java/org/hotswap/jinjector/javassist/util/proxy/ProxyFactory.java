...
package org.hotswap.jinjector.javassist.util.proxy;
...
import org.hotswap.jinjector.javassist.bytecode.DuplicateMemberException;
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "org.hotswap.jinjector.javassist.util.proxy.RuntimeSupport";
    ...
    private Class<?> getClassInTheSamePackage() {
        if (basename.startsWith("org.hotswap.jinjector.javassist.util.proxy."))       // maybe the super class is java.*
    ...
    private void checkClassAndSuperName() {
        ...
        if (basename.startsWith("java.") || basename.startsWith("jdk.") || onlyPublicMethods)
            basename = "org.hotswap.jinjector.javassist.util.proxy." + basename.replace('.', '_');
    }
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("org.hotswap.jinjector.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
