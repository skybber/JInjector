...
package org.hotswap.patcher.javassist.tools.rmi;
...
import org.hotswap.patcher.javassist.CtMethod.ConstParameter;
import org.hotswap.patcher.javassist.CtNewConstructor;
import org.hotswap.patcher.javassist.CtNewMethod;
import org.hotswap.patcher.javassist.Modifier;
import org.hotswap.patcher.javassist.NotFoundException;
import org.hotswap.patcher.javassist.Translator;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "org.hotswap.patcher.javassist.tools.rmi.Sample";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "org.hotswap.patcher.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "org.hotswap.patcher.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("org.hotswap.patcher.javassist.tools.rmi.RemoteException") };
    }
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("org.hotswap.patcher.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
